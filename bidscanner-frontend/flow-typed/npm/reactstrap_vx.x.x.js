// flow-typed signature: f81801b63ae1764ce4f21032522f0535
// flow-typed version: <<STUB>>/reactstrap_v^4.6.2/flow_v0.47.0

import React from 'react';

declare module 'reactstrap' {
  declare export var Container: Class<React.Component<void, *, *>>;
  declare export var Input: Class<React.Component<void, *, *>>;
  declare export var Button: Class<React.Component<void, *, *>>;
  declare export var Collapse: Class<React.Component<void, *, *>>;
  declare export var Nav: Class<React.Component<void, *, *>>;
  declare export var NavItem: Class<React.Component<void, *, *>>;
  declare export var Navbar: Class<React.Component<void, *, *>>;
  declare export var NavLink: Class<React.Component<void, *, *>>;
  declare export var NavbarBrand: Class<React.Component<void, *, *>>;
  declare export var Row: Class<React.Component<void, *, *>>;
  declare export var Col: Class<React.Component<void, *, *>>;
  declare export var Media: Class<React.Component<void, *, *>>;
  declare export var Badge: Class<React.Component<void, *, *>>;
  declare export var Pagination: Class<React.Component<void, *, *>>;
  declare export var PaginationLink: Class<React.Component<void, *, *>>;
  declare export var PaginationItem: Class<React.Component<void, *, *>>;
  declare export var ButtonDropdown: Class<React.Component<void, *, *>>;
  declare export var DropdownToggle: Class<React.Component<void, *, *>>;
  declare export var DropdownMenu: Class<React.Component<void, *, *>>;
  declare export var DropdownItem: Class<React.Component<void, *, *>>;
  declare export var Dropdown: Class<React.Component<void, *, *>>;
}
