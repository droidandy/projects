...
const Head = () => (
  <H
    title="Search Buy Requests"
    description="Search among thousands of RFQs published by international buyers (EPC contractors, end users, traders, service providers) and find new customers"
    keywords="rfq, rfqs, buy requests, trade leads, purchasing request, material requisitions, find customers, epc contractors, new customers"
  />
);
