module Pages
  module App::Settings
    module AccountDetails
      class Edit < Pages::App::Base
        set_url('/settings/details/edit')
        ...
        section :primary_contact, :text_node, 'primaryContact' do
          ...
          section :email, Sections::Email, :field, 'primaryContact.email'
        ...
        section :billing_contact, :text_node, 'billingContact' do
          ...
          section :billing_email, Sections::Email, :field, 'billingContact.email'
