      ...
      module Vehicles
        class DocumentsController < ApplicationController
          ...
          def kinds
            ...
            render json: ::Documents::Kinds::Index.new(search.resolved_scope.preload(:fields))
                                                  .as_json(with_fields: true)
          end
          ...
          def approve
            ...
            execute_and_process(service) do
              render json: ::Documents::Show.new(service.document).as_json(with_vehicle: true)
            end
          end
