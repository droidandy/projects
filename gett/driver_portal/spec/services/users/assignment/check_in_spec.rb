...
RSpec.describe Users::Assignment::CheckIn do
  describe '#execute!' do
    ...
    include_examples 'it uses policy', Users::AssignmentPolicy, :check_in?
    ...
    context 'with review in progress' do
      ...
      it 'assign valid attributes' do
        ...
        expect(subject.user.reviews.last.checkin_at).to be_present
      end
    end
