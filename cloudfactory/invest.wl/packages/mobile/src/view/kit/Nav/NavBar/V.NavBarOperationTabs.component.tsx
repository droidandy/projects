...
@observer
export class VNavBarOperationTabs extends React.Component<Partial<IVNavBarIconProps>> {
  ...
  public render() {
    ...
    return (
      <VNavBarIcon name={'operation-done'} onPress={this._onPress} {...this.props} />
    );
  }

  private _onPress = () => this._navigation.navigateTo(EVLayoutScreen.LayoutOperationTabs);
}
