...
@observer
export class VNavBarProfile extends React.Component<Partial<IVNavBarIconProps>> {
  ...
  public render() {
    ...
    return (
      <VNavBarIcon name={'profile'} onPress={this._onPress} {...this.props} />
    );
  }

  private _onPress = () => this._navigation.navigateTo(EVLayoutScreen.LayoutMenu);
}
