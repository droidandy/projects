import { VFilterXComposeNumberModel } from '@invest.wl/common';
...
export interface VFilterNumberProps extends IVFilterProps<VFilterXComposeNumberModel> {
}

@observer
export class VFilterComposeNumber extends React.Component<VFilterNumberProps> {
  private theme = IoC.get<VThemeStore>(VThemeStoreTid);

  @computed
  private get optionList() {
    return (this.props.model.config.domain.dto || [])
      .filter(c => Array.isArray(c.value)) as IVSelectData<number[]>;
  }

  constructor(props: VFilterNumberProps) {
    super(props);
    makeObservable(this);
  }
