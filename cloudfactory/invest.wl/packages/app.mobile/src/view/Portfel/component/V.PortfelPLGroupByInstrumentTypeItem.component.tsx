import { EDInstrumentAssetType, EDPortfelGroup, IoC } from '@invest.wl/core';
import { VButton, VCol, VProgressBar, VRow, VText, VTouchable } from '@invest.wl/mobile';
    ...
    return (
      <VTouchable.Opacity context={domain.instrumentAssetType}
        ...
        <VRow justifyContent={'space-between'}>
          ...
          {model.canBuy && (
            <VButton.Fill ph={space.lg} color={color.accent2} size={'sm'}
