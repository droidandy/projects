...
import { colorAlpha, IVFlexProps, themeStyle, VCard, VCol, VIcon, VList, VRow, VText, VTouchable } from '@invest.wl/mobile';
      ...
      <VCol>
        <VRow mb={space.lg}>
          <VRow flex justifyContent={'space-between'} pr={space.md}>
            <VText color={color.muted4} font={'body18'}>Цена</VText>
            <VRow alignItems={'center'}>
              <VIcon name={'arrow-up'} color={color.accent2} />
          ...
          <VRow flex justifyContent={'space-between'} pl={space.md}
            ...
            <VRow alignItems={'center'}>
              ...
              <VIcon name={'arrow-down'} color={color.primary1} />
            </VRow>
            <VText color={color.muted4} font={'body18'}>Количество</VText>
          </VRow>
        </VRow>
