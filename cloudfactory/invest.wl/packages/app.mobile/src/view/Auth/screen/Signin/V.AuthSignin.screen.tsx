import { EDAuthPasswordType, IoC } from '@invest.wl/core';

import { mapScreenPropsToProps, VButton, VCol, VContainer, VContent, VInputField, VNavBar, VStatusBar, VText } from '@invest.wl/mobile';
import { IVAuthSigninPresent, IVAuthSigninPresentProps, VAuthSigninPresentTid } from '@invest.wl/view/src/Auth/present/Signin/V.AuthSignin.types';
    ...
    return (
      <VContainer>
        ...
        <VContent pa={space.lg} bg={color.bg}>
          ...
          <VCol flex />
          <VButton.Fill onPress={this._signin} color={color.primary2} disabled={!pr.model.isValid}
