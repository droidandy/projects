...
import {
  IVAuthPasswordRestorePresentProps,
  VAuthPasswordRestorePresent,
  VAuthPasswordRestorePresentTid,
    ...
    return (
      <VContainer>
        ...
        <VContent pa={20} bg={theme.color.bg}>
          ...
          <VCol flex />
          <VButton.Fill mt={theme.space.lg} color={theme.color.accent2} onPress={this._restore}>
            ОТПРАВИТЬ
          </VButton.Fill>
        </VContent>
      </VContainer>
