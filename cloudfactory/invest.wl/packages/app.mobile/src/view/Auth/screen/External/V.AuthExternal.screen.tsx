...
import { mapScreenPropsToProps, VContainer, VContent, VNavBar, VStatusBar, VStub, VWebView, VWebViewModel } from '@invest.wl/mobile';
import { IVAuthExternalPresentProps, VAuthExternalPresent, VAuthExternalPresentTid } from '@invest.wl/view/src/Auth/present/V.AuthExternal.present';
