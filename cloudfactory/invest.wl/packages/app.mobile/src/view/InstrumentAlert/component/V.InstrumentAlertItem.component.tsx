...
import { IVFlexProps, VCol, VFormat, VIcon, VList, VProgressBar, VSwipeableRow, VText, VTouchable } from '@invest.wl/mobile';
        ...
        <VCol bg={color.base} pa={space.lg} {...flexProps}>
          ...
          {!model.domain.isCompleted && (
            <>
              ...
              >Осталось до исполнения <VText color={color.positive}
