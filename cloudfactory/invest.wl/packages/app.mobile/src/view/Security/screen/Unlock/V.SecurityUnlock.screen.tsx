...
import { mapScreenPropsToProps, VButton, VCol, VContainer, VContent, VIcon, VImage, VNavBar, VStatusBar } from '@invest.wl/mobile';
import { VCustomerAccountSelfPresent, VCustomerAccountSelfPresentTid } from '@invest.wl/view/src/Customer/present/V.CustomerAccountSelf.present';

import {
  IVSecurityUnlockPresentProps,
  VSecurityUnlockPresent,
  VSecurityUnlockPresentTid,
...
export class VSecurityUnlockScreen extends React.Component<IVSecurityUnlockScreenProps> {
  ...
  private get leftButtonRender() {
    if (!this.pr.cse.biometryEnabled) {
      return null;
    }
    return (
      <VButton.Text>
