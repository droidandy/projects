import {
  IApiResponse,
  IDFileDownloadRequestDTO,
  IDFileDownloadResponseDTO,
  IDFileUploadRequestDTO,
  IDFileUploadResponseDTO,
  Inject,
  Injectable,
} from '@invest.wl/core';
...
import { STransportFileService, STransportFileServiceTid } from '@invest.wl/system/src/Transport/File/S.TransportFile.service';
