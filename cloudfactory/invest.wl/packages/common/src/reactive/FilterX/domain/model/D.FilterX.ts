import { IObjectItem } from '@invest.wl/core';
import { action, computed, makeObservable } from 'mobx';
import { DModelX } from '../../../ModelX/D.ModelX.model';
import { IDFilterXComposeModel, IDFilterXConfigItemMap, IDFilterXConfigMap, IDFilterXMap, IDFilterXModelVariant, IDFilterXTarget } from '../D.FilterX.types';
import { DFilterXComposeModel } from './D.FilterXCompose.model';
import { DFilterXConfigModel } from './D.FilterXConfig.model';

export class DFilterX<I extends IDFilterXTarget> extends DModelX.Value<IDFilterXMap<I>> {
