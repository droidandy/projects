...
export class DFilterXDateModel extends DFilterXModel<Date> {
  ...
  constructor(dtoLV: ILambda<Date | undefined>, operator?: TDFilterXDateOperator, config?: IDFilterXConfigModel<Date>) {
  ...
  public clone() {
    return new DFilterXDateModel(this._dtoLV, this.operator as any, this.config);
  }
}
