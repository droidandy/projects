import {
  EDDocumentStatus, EDDocumentType, IApiResponse, IDDocumentCreateManyRequestDTO, IDDocumentCreateManyResponseDTO,
  IDDocumentCreateRequestDTO, IDDocumentCreateResponseDTO, IDDocumentDTO, IDDocumentListManyRequestDTO,
  IDDocumentListManyResponseDTO, IDDocumentListRequestDTO, IDDocumentListResponseDTO, IDDocumentSignConfirmRequestDTO,
  IDDocumentSignConfirmResponseDTO, IDDocumentSignPrepareRequestDTO, IDDocumentSignPrepareResponseDTO,
  IDDocumentSmsSendRequestDTO, IDDocumentSmsSendResponseDTO, Inject, Injectable,
} from '@invest.wl/core';
import { IDDocumentAdapter } from '@invest.wl/domain/src/Document/D.Document.types';
import uniqBy from 'lodash/uniqBy';
import flatMap from 'lodash/flatMap';
import {
  STransportDocumentService, STransportDocumentServiceTid,
} from '@invest.wl/system/src/Transport/Document/S.TransportDocument.service';
