    ...
    return (
      <VContainer>
        ...
        <VNavBar>
          ...
          <VNavBar.RightText color={theme.color.accent1} title={'ВЫЙТИ'} onPress={pr.signOut} />
        </VNavBar>
  ...
  private _contentRender() {
    ...
    return (<>
      ...
      <VCol flex justifyContent={'center'} alignItems={'center'}>
        <VIcon name={biometry.iconName} fontSize={72} color={theme.color.text} />
      </VCol>
      ...
      <VButton.Fill mt={theme.space.xl} color={theme.color.accent1} onPress={pr.access}>
        Подключить
      </VButton.Fill>
    </>);
  }
