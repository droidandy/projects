  ...
  public render() {
    ...
    return (
      <VContainer>
        ...
        <VNavBar>
          <VNavBar.Back />
          <VNavBar.Title text={infoX.model?.instrumentIdentity?.name} />
        </VNavBar>
    ...
    return (
      <>
        ...
        {!!infoX.model?.instrumentIdentity && (
          <VCard mt={space.lg} alignItems={'center'} pa={space.lg} key={(!!instrumentSummaryX.model).toString()}>
            <VRow alignItems={'center'} justifyContent={'center'}>
              <VIcon name={'warning'} fontSize={24} color={color.text} />
