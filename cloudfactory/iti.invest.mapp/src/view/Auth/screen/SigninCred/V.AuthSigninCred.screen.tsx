...
import {
  IVAuthSigninCredPresent, IVAuthSigninCredPresentProps, VAuthSigninCredPresentTid,
    ...
    return (
      <VContainer>
        ...
        <VContent pa={space.lg} bg={color.bg}>
          ...
          <VCol flex />
          <VButton.Fill onPress={this._signin} color={color.accent1} disabled={!pr.model.isValid} mt={space.lg}>
            Войти
          </VButton.Fill>
          <VButton.Stroke mt={space.lg} color={color.accent1} onPress={this._passwordRestore}>
            Восстановить пароль
          </VButton.Stroke>
        </VContent>
      </VContainer>
