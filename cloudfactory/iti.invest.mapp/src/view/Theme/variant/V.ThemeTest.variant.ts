...
export const VThemeTestVariant = new VThemeModel(
  {
    name: 'test',
    color: {
      base: colors.white,
    ...
    kit: {
      ...
      Switch: {
        cBg: colors.white,
        cDisabled: colors.text,
        cActive: colors.green1,
        cInactive: colors.bgContent,
      },
      ...
      StatusBar: {
        ...
        sHeight: { md: Platform.OS === 'ios' ? 20 : StatusBar.currentHeight },
        cBg: colors.white,
