...
export const VThemeDefaultVariant = new VThemeModel(
  {
    ...
    color: {
      ...
      primary3: colors.blue,

      accent1: colors.orange1,
      accent2: colors.orange1,
    },
    space: {
      xs: 2,
      sm: 4,
    ...
    kit: {
      ...
      Button: {
        ...
        cDisabled: colors.orange1,
        cMain: colors.orange1,
        cText: colors.base,
      ...
      Select: {
        ...
        Radio: {
          ...
          checked: {
            ...
            // cBg: colors.white,
            cBg: [colors.orange1, colors.orange1],
            sHeight: { md: 20 },
            sWidth: { md: 20 },
            sRadius: { md: 10 },
            sFont: { md: 10 },
      ...
      Format: {
        Number: {
          ...
          float: {
            sm: { fText: textStyles.body10, cText: colors.text },
            md: { fText: textStyles.body10, cText: colors.text },
            lg: { fText: textStyles.title3, cText: colors.text },
          },
        },
      },
      Hyperlink: {
