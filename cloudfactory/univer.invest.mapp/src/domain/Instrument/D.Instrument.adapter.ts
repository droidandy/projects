...
import {
  EDInstrumentAssetType, IDInstrumentFavoriteUserUpdateRequestDTO, IDInstrumentFavoriteUserUpdateResponseDTO,
  IDInstrumentInfoRequestDTO, IDInstrumentInfoResponseDTO, IDInstrumentMarketHistoryListRequestDTO,
  IDInstrumentMarketHistoryListResponseDTO, IDInstrumentQuoteItemDTO, IDInstrumentQuoteListRequestDTO,
  IDInstrumentQuoteListResponseDTO, IDInstrumentSearchItemDTO, IDInstrumentSearchRequestDTO,
  IDInstrumentSearchResponseDTO, IDInstrumentSummaryRequestDTO, IDInstrumentSummaryResponseDTO,
} from '@invest.wl/core/src/dto/Instrument';
...
import {
  STransportMarketService, STransportMarketServiceTid,
} from '@invest.wl/system/src/Transport/Market/S.TransportMarket.service';
...
import {
  IDInstrumentExchangeOptsDTO, IDInstrumentExchangeRequestDTO,
} from '@invest.wl/core/src/dto/Instrument/D.InstrumentExchange.dto';
