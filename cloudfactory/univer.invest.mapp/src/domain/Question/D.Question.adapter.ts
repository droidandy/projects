import {
  EDQuestionDisplayType, IApiResponse, IDQuestionAnswerSaveRequestDTO, IDQuestionAnswerSaveResponseDTO, IDQuestionDTO,
  IDQuestionListRequestDTO, IDQuestionListResponseDTO, IDQuestionSectionDTO, IDQuestionSectionListRequestDTO,
  IDQuestionSectionListResponseDTO, Inject, Injectable,
} from '@invest.wl/core';
import { IDQuestionAdapter } from '@invest.wl/domain/src/Question/D.Question.types';
import {
  STransportQuestionService, STransportQuestionServiceTid,
} from '@invest.wl/system/src/Transport/Question/S.TransportQuestion.service';
