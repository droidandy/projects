import { IApiResponse, Inject, Injectable } from '@invest.wl/core';
import { IDAddressAdapter } from '@invest.wl/domain/src/Address/D.Address.types';
import {
  STransportDaDataService, STransportDaDataServiceTid,
} from '@invest.wl/system/src/Transport/DaData/S.TransportDaData.service';
import {
  IDAddressSearchRequestDTO, IDAddressSearchResponseDTO,
} from '@invest.wl/core/src/dto/Address/D.AddressSearch.dto';
