...
import {
  VAddressSearchPresent, VAddressSearchPresentTid,
} from '@invest.wl/view/src/Address/present/V.AddressSearch.present';
...
import {
  VButton, VCol, VInputField, VList, VModalBottom, VRow, VText, VTouchable,
