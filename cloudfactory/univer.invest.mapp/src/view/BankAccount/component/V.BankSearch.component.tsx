...
import { VButton, VCol, VInputField, VList, VModalBottom, VText, VTouchable } from '@invest.wl/mobile/src/view/kit';
...
import {
  VBankSearchPresent, VBankSearchPresentTid,
} from '@invest.wl/view/src/BankAccount/present/V.BankSearch.present';
