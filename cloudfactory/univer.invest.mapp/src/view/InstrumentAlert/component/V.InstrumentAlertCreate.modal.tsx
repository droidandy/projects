    ...
    return (
      <VModalDialog {...modalProps}>
        ...
        <VModalDialog.Actions>
          <VButton.Fill flex radius={0} color={color.decorLight} colorText={color.primary1} disabled={this._isLoading}
            leftBottomRadius={kit.ModalDialog.sRadius?.md}
            onPress={this.props.onClose}>Отмена</VButton.Fill>
          <VButton.Fill flex radius={0} color={color.primary1} disabled={this._isLoading}
