...
export const VThemeDefaultVariant = new VThemeModel(
  {
    ...
    color: {
      ...
      muted1: colors.gray1,
      muted2: colors.gray2,
      muted3: colors.lightGray,
      muted4: colors.darkGray,

      primary1: colors.baseBlue,
      primary2: colors.blue,
      primary3: colors.baseBlue,

      accent1: colors.baseBlue,
      accent2: colors.blue,
    },
    space: {
      xs: 2,
    ...
    kit: {
      ...
      Chart: {
        ...
        Marker: {
          ...
          line: {
            cBg: colors.lightGray,
            sWidth: { md: 1 },
          },
          circle: {
            cBg: colors.white,
            cBorder: colors.greenChart,
            sWidth: { md: 12 },
            sBorder: { md: 2 },
          },
          offsetY: {
      ...
      Format: {
        Number: {
          int: {
            ...
            md: { fText: textStyles.body2, cText: colors.text },
            lg: { fText: textStyles.title2, cText: colors.text },
          },
          float: {
            sm: { fText: textStyles.body6, cText: colors.text },
            md: { fText: textStyles.body3, cText: colors.text },
            lg: { fText: textStyles.title6, cText: colors.text },
          },
        },
      },
      Hyperlink: {
