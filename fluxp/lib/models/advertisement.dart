...
//        }
  ...
  static googleAdInit() {
    if (!kIsWeb) {
      FirebaseAdMob.instance.initialize(
        appId: Platform.isAndroid ? kAdConfig['androidAppId'] : kAdConfig['iosAppId'],
      );
  ...
  static BannerAd createBannerAd() {
    if (!kIsWeb) {
      return BannerAd(
        ...
        adUnitId: Platform.isAndroid ? kAdConfig['androidUnitBanner'] : kAdConfig['iosUnitBanner'],
  ...
  static showInterstitialAd() {
    ...
    Future.delayed(Duration(seconds: kAdConfig['waitingTimeToDisplayInterstitial']), () async {
  ...
  static void showRewardedVideoAd() {
    if (!kIsWeb) {
      ...
      Future.delayed(Duration(seconds: kAdConfig['waitingTimeToDisplayReward']), () async {
