...
const Dropdown = ({ children, items, large }) => {
  ...
  return (
    <div className={styles.dropdown}>
      ...
      <div className={cn("menu", styles.menu, { _open: open })}>
        ...
        {items?.map((e, i) => (
          <div className={cn(styles.item, { large: large })} key={i}>
            <img src={`/icons/product/${e.img}.svg`} />
            <div>
              <strong>
                <a href={e.link} target={e.blank ? "_blank" : "_self"} rel={e.rel}>
                  {e.title}
                </a>
              </strong>
