  ...
  <>
    <div className={styles.content}>
      <label className="subheader-medium h4">
        Fetch user state in <br /> a real time through SDK
      </label>
      <p className="text text_xl">
        Get user subscription state and give access to premium features when
        needed.
      </p>
    ...
    <div className={styles.user}>
      ...
      <label className="h4">User</label>
      <div className={styles.list}>
        <div className={styles.item}>
          <div className={styles.step}>
            <div style={{ border: "3px solid #ffd12d" }}>A</div>
            <div style={{ backgroundColor: "#ffd12d" }}>
              <img src={require("../images/rocket.svg")} alt="Trial User" />
            </div>
          </div>
        ...
        <div className={styles.item}>
          <div className={styles.step}>
            <div style={{ border: "3px solid #93e6cf" }}>B</div>
            <div style={{ backgroundColor: "#93e6cf" }}>
              <img src={require("../images/dollar.svg")} alt="Playing User" />
            </div>
          </div>
        ...
        <div className={styles.item}>
          <div className={styles.step}>
            <div style={{ border: "3px solid #fc5050" }}>C</div>
            <div style={{ backgroundColor: "#fc5050" }}>
              <img src={require("../images/close.svg")} className="close" alt="Subscription Cancelled" />
            </div>
          </div>
