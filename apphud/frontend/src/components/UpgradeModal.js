...
class UpgradeModal extends React.Component {
  render() {
    const { close, application, userBillingUsage } = this.props
          ...
          <div style={{ padding: "20px 30px" }} className="upgrade-plan__modal">
            ...
            {user_collaboration.role === "owner" ? (
              <div className="upgrade-plan__modal-description ta-center">
                You are growing fast and it’s time to upgrade your plan!
                <br />
                <b>
              ...
              <div className="upgrade-plan__modal-description ta-center">
                You are growing fast and it’s time to upgrade your plan! Please
                ask app owner{" "}
                <b>
                  (
            ...
            <ul className="upgrade-plan__modal-list">
            ...
            <div className="ta-center">
              {user_collaboration.role === "owner" && (
                <NavLink
                  ...
                  className="button button_green button_225 button_inline-block mt30"
                >
                  Upgrade plan
                </NavLink>
              )}
              ...
              {user_collaboration.role === "owner" && (
                <div className="mt10">
                  <NavLink
                    to="/profile/billing"
                    className="link mt10 link_normal"
                  >
