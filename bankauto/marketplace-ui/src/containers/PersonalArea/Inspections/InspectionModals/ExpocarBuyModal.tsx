...
import { SuccessSmalIcon } from '../icons';
import { ModalLight } from 'components/ModalLight'; //TODO заменить в модуле
import { FORM_ACTION, INSPECTIONS_CONTRACT_OFFER, INSPECTION_PRICE } from '../constants';
...
export const InfoItem: FC<{ text: string }> = ({ text }) => {
  ...
  return (
    <div className={s.infoItem}>
      <SuccessSmalIcon width="1.25rem" height="1.25rem" viewBox="0 0 20 20" className={s.icon} />
