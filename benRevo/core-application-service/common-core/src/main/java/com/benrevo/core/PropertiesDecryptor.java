...
import static com.benrevo.core.PropertiesDecryptor.PropertyResource.Key.analytics;
import static com.benrevo.core.PropertiesDecryptor.PropertyResource.Key.auth0;
import static com.benrevo.core.PropertiesDecryptor.PropertyResource.Key.aws;
import static com.benrevo.core.PropertiesDecryptor.PropertyResource.Key.salesforce;
...
import com.benrevo.core.PropertiesDecryptor.PropertyResource.Key;
...
public class PropertiesDecryptor implements EnvironmentPostProcessor, Ordered {
    ...
    enum PropertyResource {
        ...
        // Analytics
        analytics_override(analytics, US_EAST_1, false, false),
        analytics_preprod(analytics, US_EAST_1, false, true),
        analytics_prod(analytics, US_WEST_2, true, true),
