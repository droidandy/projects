...
class Terms extends React.Component { // eslint-disable-line react/prefer-stateless-function
                ...
                <Grid stackable className="benefits">
                  <Grid.Row centered>
                    <Grid.Column width={13}>
                      <div>
                        <h5 className="terms-effective">Version 2</h5>
                        <h5 className="terms-effective">Effective Date: August 21st, 2017</h5>
                        <h5>Last Updated Date: July 1st, 2018</h5>
                        <p>BenRevo (<b>“Provider”</b> or <b>“we”</b> or <b>“us”</b>) is committed to protecting your privacy. We have prepared this Privacy Policy to describe to you our practices regarding the Personal Data (as defined below) that we collect from users of our website (<b>“Users”</b>),  located at <a href="https://www.benrevo.com" target="_tab">www.benrevo.com</a> (<b>“Website”</b>), and related services (<b>“Services”</b>). Any terms not defined herein shall have the meaning given to them in the associated <Link to="/privacy">www.benrevo.com/privacy</Link>.</p>
                        <h4>USER CONSENT</h4>
                        ...
                        <ol>
                          ...
                          <li>provide the Services you request, such as, providing a comparison between Anthem and UnitedHealthcare’s insurance pricing information and the values inputted by you;</li>
                        ...
                        <p>To the extent that you, as an insurance broker, submit or upload your clients’ Personal Data to us (in the form of a census file, etc.), you confirm that you own or have all the necessary rights to provide such Personal Data and agree to indemnify BenRevo for any losses resulting from such submission by you or use of such Personal Date by BenRevo or its partners.</p>
                        <p>
                        ...
                        <p><b>Insurance Provider Users.</b>  We will share a User’s Personal Data with Anthem, Inc., and its affiliates; UnitedHealthcare, Inc. and its affiliates, solely for the purpose of providing the Services.</p>
