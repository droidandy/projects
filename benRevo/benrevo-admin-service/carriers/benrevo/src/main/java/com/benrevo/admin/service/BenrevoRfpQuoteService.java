...
@AppCarrier(BENREVO)
@Transactional
public class BenrevoRfpQuoteService extends BaseAdminRfpQuoteService{

    /**********************
     *
     * Note: Currently this class is a copy of UHCRfpQuoteService, we need to enable the ability to
     * load UHC quotes (new business + renewal) in the Admin Tool for Broker App. 
     *
     **********************/
    ...
    protected void setSelectedRfpQuoteNetworkPlan(RfpQuoteOptionNetwork rqon,
        ...
        if (isMedical) {
            if (rxMatching == null && rqon.getClientPlan().getRxPnn() != null) {
                throw new IllegalArgumentException(String.format(
