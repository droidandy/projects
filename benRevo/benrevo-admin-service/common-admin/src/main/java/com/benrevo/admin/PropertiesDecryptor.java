...
import static com.benrevo.admin.PropertiesDecryptor.PropertyResource.Key.auth0;
import static com.benrevo.admin.PropertiesDecryptor.PropertyResource.Key.aws;
import static com.benrevo.admin.PropertiesDecryptor.PropertyResource.Key.salesforce;
...
import com.benrevo.admin.PropertiesDecryptor.PropertyResource.Key;
...
public class PropertiesDecryptor implements EnvironmentPostProcessor, Ordered {
    ...
    Regions getRegion(ConfigurableEnvironment env) {
        return equalsIgnoreCase(APP_ENV, "prod") || APP_CARRIER.abbreviation.equals("benrevo") ? US_WEST_2 : US_EAST_1;
    }
}
