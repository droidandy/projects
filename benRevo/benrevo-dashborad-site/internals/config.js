...
const ReactBoilerplate = {
  ...
  dllPlugin: {
    defaults: {
      ...
      // The path where the DLL manifest and bundle will get built  UHC_PATH_FIX
      pathUHC: resolve('../node_modules/react-boilerplate-dlls/uhc'),
      pathANTHEM: resolve('../node_modules/react-boilerplate-dlls/anthem'),
    },
