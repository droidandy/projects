      ...
      <Grid.Row>
        <Grid.Column width={16}>
          ...
          <p>
            ...
            - Rates are guaranteed for the contract period of 1/1/18 through 12/31/18.<br />
            ...
            - This proposal assumes at least 91% of all benefit eligible employees (including spousal waivers) will enroll with United Healthcare.  If this assumption is not accurate, we reserve
          the right to requote back to original effective date.<br />
            ...
            - If this quote is based off information provided from an RFP that did not include claims experience or renewal rates, final approval is contingent upon
