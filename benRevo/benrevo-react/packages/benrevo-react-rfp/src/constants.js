...
export const UPDATE_PLANS_LOADED = 'UPDATE_PLANS_LOADED';
...
export const CARRIER_TO_DEFAULT = 'CARRIER_TO_DEFAULT';
...
export const PLANS_TO_DEFAULT = 'PLANS_TO_DEFAULT';
...
export const RFP_PLANS_GET = 'RFP_PLANS_GET';
export const RFP_PLANS_GET_SUCCESS = 'RFP_PLANS_GET_SUCCESS';
export const RFP_PLANS_GET_ERROR = 'RFP_PLANS_GET_ERROR';

export const RFP_ANCILLARY_PLANS_GET = 'RFP_ANCILLARY_PLANS_GET';
export const RFP_ANCILLARY_PLANS_GET_SUCCESS = 'RFP_ANCILLARY_PLANS_GET_SUCCESS';
export const RFP_ANCILLARY_PLANS_GET_ERROR = 'RFP_ANCILLARY_PLANS_GET_ERROR';

export const RFP_PLANS_SAVE = 'RFP_PLANS_SAVE';
export const RFP_PLANS_SAVE_SUCCESS = 'RFP_PLANS_SAVE_SUCCESS ';
export const RFP_PLANS_SAVE_ERROR = 'RFP_PLANS_SAVE_ERROR';

export const RFP_ANCILLARY_PLANS_SAVE = 'RFP_ANCILLARY_PLANS_SAVE';
export const RFP_ANCILLARY_PLANS_SAVE_SUCCESS = 'RFP_ANCILLARY_PLANS_SAVE_SUCCESS ';
export const RFP_ANCILLARY_PLANS_SAVE_ERROR = 'RFP_ANCILLARY_PLANS_SAVE_ERROR';

export const SET_PENDING_PLANS = 'SET_PENDING_PLANS';
...
export const ATTR_VALID_WAIVERS = 'VALID_WAIVERS';
export const ATTR_INVALID_WAIVERS = 'INVALID_WAIVERS';
export const ATTR_FIXED_UW_COMMENTS = 'FIXED_UW_COMMENTS';
export const ATTR_TEXT_UW_COMMENTS = 'TEXT_UW_COMMENTS';
export const ATTR_KAISER_OR_SIMNSA = 'KAISER_OR_SIMNSA';
