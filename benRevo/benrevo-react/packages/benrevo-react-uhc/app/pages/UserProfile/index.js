  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <Grid stackable container className="uhc-user-profile section-wrap">
          <Grid.Column width={16}>
            <Grid stackable textAlign="center">
              <Grid.Row>
                <Grid.Column width={9}>
                  <div className="benrevo-logo">
                    <div className="powered">powered by</div>
                    <Image src={Benrevo} />
                  </div>

                  <div className="profile-header">
                    <Header as="h1">Welcome to UnitedHealthcare!</Header>
                  ...
                  <Grid.Column width="9" className="field-button">
                    <Button disabled={!firstName || !lastName || !userEULA} className="form-home-button" onClick={this.props.saveInfo}>Save & Continue</Button>
                  </Grid.Column>
