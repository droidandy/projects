...
import { loggedIn, AlertError, AlertWarning, AlertInfo, AlertSuccess } from '@benrevo/benrevo-react-core';
...
class App extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    ...
    if (!this.props.checkingRole) {
      return (
        <div id="container-center" className="container-center app-container">
          <Grid container>
    ...
    return (
      <div className="app-container-empty"></div>
    );
  }
}
