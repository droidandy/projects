...
// Auth0:  www.auth0.com
export const AUTH0_CLIENT_ID = process.env.AUTH0_CLIENT_ID || 'sgHcHFge9CWD48Asz77uM7YsmbHRUzWQ';
export const AUTH0_DOMAIN = process.env.AUTH0_DOMAIN || 'benrevo.auth0.com';
export const AUTH0_DOMAIN_LOGIN = process.env.AUTH0_DOMAIN_LOGIN || 'https://login.auth0.com/api/v2';

export const MIXPANEL_KEY = process.env.MIXPANEL_KEY || 'edf088da36c0bcbeb386911a089c4ff6';
