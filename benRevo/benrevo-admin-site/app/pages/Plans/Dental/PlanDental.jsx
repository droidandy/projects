...
class PlanDental extends React.Component { // eslint-disable-line react/prefer-stateless-function
    ...
    return (
      <div>
        <Helmet
          title="Dental"
          meta={[
            { name: 'description', content: 'Description of Dental' },
          ]}
        />
