...
export const getTitleData = (lang) => {
  return "Emails/Orders/ShippingUpdate/" + lang.toUpperCase();
};
...
const props = {
  ...
  options: {
    ...
    fulfillment: {
      ...
      tracking_number: 123,
      tracking_numbers: [123, 122, 121, 111],
      tracking_url: "https://tracking.number/123",
      tracking_urls: [
        "https://tracking.number/123",
        "https://tracking.number/122",
        "https://tracking.number/121",
        "https://tracking.number/111",
      ],
      receipt: {},
      name: "#7908.1",
    },
