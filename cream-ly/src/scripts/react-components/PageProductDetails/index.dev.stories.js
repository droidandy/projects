...
export const CleanMySkin = (extraProps) => {
  return stories.CleanMySkin({ ...extraProps, lang });
};
export const GiftCard = (extraProps) => {
  return stories.GiftCard({ ...extraProps, lang });
};

export const IndividualSkinCareHelp = (extraProps) => {
  return stories.IndividualSkinCareHelp({ ...extraProps, lang });
};

export const IndividualConsultationWithAlena = (extraProps) => {
  return stories.IndividualConsultationWithAlena({ ...extraProps, lang });
};

export const ConsultationFaceMassage = (extraProps) => {
  return stories.ConsultationFaceMassage({ ...extraProps, lang });
};
