//https://kit.fontawesome.com/9eca461f6a.js
//used or ruble sign
      ...
      (function() {
        ...
        .then(function(t) {
          t.map(function(t) {
            ...
            I.detectingConflicts &&
              U &&
              T(function() {
                U.setAttributeNode(
                  document.createAttribute(I.detectionIgnoreAttr)
                );
                var t = (function(t, e) {
                  var n = document.createElement("script");
                  return (
